...
SERVICE_NAME = "lambdamicrovms"
CRD_GROUP = "lambdamicrovms.services.k8s.aws"
...
def load_lambdamicrovms_resource(resource_name: str, additional_replacements: Dict[str, Any] = {}):
