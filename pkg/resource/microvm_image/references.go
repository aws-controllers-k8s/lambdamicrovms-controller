...
func (rm *resourceManager) ResolveReferences(
	...
	if fieldHasReferences, err := rm.resolveReferenceForBuildRoleARN(ctx, apiReader, ko); err != nil {
...
// identifier field.
func validateReferenceFields(ko *svcapitypes.MicrovmImage) error {

	if ko.Spec.BuildRoleRef != nil && ko.Spec.BuildRoleARN != nil {
		return ackerr.ResourceReferenceAndIDNotSupportedFor("BuildRoleARN", "BuildRoleRef")
	}
	if ko.Spec.BuildRoleRef == nil && ko.Spec.BuildRoleARN == nil {
		return ackerr.ResourceReferenceOrIDRequiredFor("BuildRoleARN", "BuildRoleRef")
	}
	return nil
}

// resolveReferenceForBuildRoleARN reads the resource referenced
// from BuildRoleRef field and sets the BuildRoleARN
// from referenced resource. Returns a boolean indicating whether a reference
// contains references, or an error
func (rm *resourceManager) resolveReferenceForBuildRoleARN(
	ctx context.Context,
	apiReader client.Reader,
	ko *svcapitypes.MicrovmImage,
) (hasReferences bool, err error) {
	if ko.Spec.BuildRoleRef != nil && ko.Spec.BuildRoleRef.From != nil {
		hasReferences = true
		arr := ko.Spec.BuildRoleRef.From
		if arr.Name == nil || *arr.Name == "" {
			return hasReferences, fmt.Errorf("provided resource reference is nil or empty: BuildRoleRef")
		}
		...
		ko.Spec.BuildRoleARN = (*string)(obj.Status.ACKResourceMetadata.ARN)
	}
