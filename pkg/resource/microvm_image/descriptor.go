...
const (
	FinalizerString = "finalizers.lambdamicrovms.services.k8s.aws/MicrovmImage"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("microvmimages")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.MicrovmImage{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.MicrovmImage),
	}
}
