...
// +kubebuilder:rbac:groups=lambdamicrovms.services.k8s.aws,resources=microvms,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambdamicrovms.services.k8s.aws,resources=microvms/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"EgressNetworkConnectors", "IngressNetworkConnectors", "MaximumDurationInSeconds"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.IngressNetworkConnectors != nil && latestKo.Spec.IngressNetworkConnectors == nil {
		latestKo.Spec.IngressNetworkConnectors = observedKo.Spec.IngressNetworkConnectors
	}
	if observedKo.Spec.MaximumDurationInSeconds != nil && latestKo.Spec.MaximumDurationInSeconds == nil {
		latestKo.Spec.MaximumDurationInSeconds = observedKo.Spec.MaximumDurationInSeconds
	}
