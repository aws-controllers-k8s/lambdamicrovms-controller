...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.MicrovmID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["microvmID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: microvmID"))
	}
	r.ko.Status.MicrovmID = &primaryKey
