...
const (
	FinalizerString = "finalizers.lambdamicrovms.services.k8s.aws/Microvm"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("microvms")
